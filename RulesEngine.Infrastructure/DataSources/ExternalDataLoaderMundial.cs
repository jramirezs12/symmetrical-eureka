...
{
    public class ExternalDataLoaderMundial : IExternalDataLoader
    {
        ...
        public ExternalDataLoaderMundial(IUtilityService utilityService,
        ...
        public async Task<BlobStorage> GetBlobStorageAsync(string tenant)
        {
            ...
            return await _utilityService.GetOrSetDataCache(blobKey, () =>
                _blobStorageRepository.FindOneAsync(x => x.Tenant == tenant && x.BusinessCode == "BLS_002"), 2);
        }
