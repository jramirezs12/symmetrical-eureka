...
namespace RulesEngine.Application.Clients.Mundial.Invoices.Helper;

public class QueryExecutorPerPhaseMundial : IQueryExecutorPerPhase
{
    ...
    public QueryExecutorPerPhaseMundial(IConstantsRepository constantsRepository,
