    ...
    public class IpsCatastrophicEventRule_22 : Rule
    {
        ...
        private AlertSolidaria CreateAlert(InvoiceToCheckSolidaria invoiceToCheck)
        {
            ...
            return new AlertSolidaria
            {
                ...
                Description = "La póliza en la tabla de origen es igual a la póliza en la tabla de consulta y no tiene resultado de investigación asociado al siniestro",
                Message = $"Se debe enviar a investigar, caso catastrofico",
