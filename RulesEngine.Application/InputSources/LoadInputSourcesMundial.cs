...
using static RulesEngine.Domain.RulesEntities.Mundial.Entities.InvoiceToCheck;
using Date = RulesEngine.Domain.ValueObjects.Date;

namespace RulesEngine.Application.InputSources;

public class LoadInputSourcesMundial
{
    private readonly IInvoiceRepository _InvoiceRepository;
    private readonly InputSourcesModel _sourcesModel;
    private readonly InvoiceData _Data;
    private InvoiceToCheck _Entity;
    private string _Stage;
    private readonly IUtilityService _utilityService;

    public LoadInputSourcesMundial(InvoiceToCheck invoice, InvoiceData data, string stage, 
    ...
    public async Task<InvoiceToCheck> Create()
    {
    ...
    private static InvoiceToCheck FillInformation(InvoiceData data, InvoiceToCheck dataTofill)
    {
