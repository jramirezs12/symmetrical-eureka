...
{
    public class IpsInvestigationFromFile : IInputSource<IpsInvestigation>
    {
        ...
        public IpsInvestigationFromFile(string connectionString, SharedResource resource)
        {
            _connectionString = connectionString;
            _resource = resource;
        }

        public async Task<List<IpsInvestigation>> Create()
        {
